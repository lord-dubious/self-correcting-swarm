...
This guide gives a safe way to evaluate **Self-Correcting Swarm** locally. The commands favor help screens, mock/dry-run paths, or clearly labeled local execution so the demo stays honest.
...
- **Problem**: Experimental coding-swarm workflow using Gemini, LibCST refactoring, Docker sandbox execution, and provenance metadata for generated outputs.
